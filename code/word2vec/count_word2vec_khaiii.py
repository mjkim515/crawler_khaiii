...
def main():
    ...
    with open(path, 'r', encoding="utf-8") as file:
        ...
        for line in file.readlines():
            ...
            #for text in text_lines:
                #print(text)
            analyzed = khai.analyze(content) #kkma.pos(content)
    ...
    wakati_file = input_model_name +"_khaiii.txt"
    #print(wakati_file)
    ...
    model_name = input_model_name + '_khaiii.model'
    ...
    wordInfo = dict()
    path = paper_name + "_top keywords_khaiii.csv"
...
def saveGraph(word_info, paper_name):
    ...
    plt.title(paper_name + "_Top 20 키워드! [v.Khaiii 형태소]")
